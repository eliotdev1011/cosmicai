    ...
    g.jsxs("footer", {
      ...
      children: [
        ...
        g.jsxs("section", {
          ...
          children: [g.jsx("div", { className: "col-span-full xl:col-span-2", children: g.jsx("a", { href: "/", className: "font-bold text-xl flex", children: g.jsx("img", { src: W3, alt: "Logo", className: "h-20 md:h-20 lg:h-auto w-auto", style: { minWidth: "40px" } }) }) }), g.jsxs("div", { className: "flex flex-col gap-2", children: [g.jsx("h3", { className: "font-bold text-lg", children: "Follow US" }), g.jsx("div", { children: g.jsx("a", { target: "_blank", href: "https://x.com/", className: "opacity-60 hover:opacity-100", children: "𝕏" }) }), g.jsx("div", { children: g.jsx("a", { target: "_blank", href: "https://warpcast.com/stellaryai", className: "opacity-60 hover:opacity-100", children: "" }) })] }), g.jsxs("div", { className: "flex flex-col gap-2", children: [g.jsx("h3", { className: "font-bold text-lg", children: "" }), g.jsx("div", { children: g.jsx("a", { href: "mailto:contact@stellaryai.com", className: "opacity-60 hover:opacity-100", children: "" }) })] }), g.jsxs("div", { className: "flex flex-col gap-2", children: [g.jsx("h3", { className: "font-bold text-lg", children: "About" }), g.jsx("div", { children: g.jsx(WP, { to: "/doc", className: "opacity-60 hover:opacity-100", children: "Docs" }) }), g.jsx("div", { children: g.jsx("a", { target: "_blank", href: "", className: "opacity-60 hover:opacity-100", children: "" }) })] }), g.jsxs("div", { className: "flex flex-col gap-2", children: [g.jsx("h3", { className: "font-bold text-lg", children: "Community" }), g.jsx("div", { children: g.jsx("a", { target: "_blank", href: "https://x.com/", className: "opacity-60 hover:opacity-100", children: "Twitter" }) }), g.jsx("div", { children: g.jsx("a", { target: "_blank", href: "https://t.me/", className: "opacity-60 hover:opacity-100", children: "Telegram" }) })] })],
        }),
              ...
              g.jsxs("div", {
                ...
                children: [
                  ...
                  hover:opacity-90 transition-opacity px-6 py-2 text-md font-medium`,
                      onClick: () => (window.location.href = "https://app.stellaryai.com/"),
                      children: "Launch App",
                    }),
                  }),
